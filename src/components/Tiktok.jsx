...
const Tiktok = () => {
  return (
    <div className=" overflow-hidden py-10 relative">
      <div className=" z-10 flex flex-col max-w-[1040px] py-10 w-11/12 mx-auto">
        <div className=" z-10 text-center text-2xl mb-10 font-semibold">
          <h3 className="">Follow Us on Tiktok</h3>
          <h3>@overlord.delight</h3>
        </div>

        <div className="z-20 grid grid-cols-1 md:grid-cols-3 gap-5">
      ...
      <div className=" z-0 absolute  -bottom-14 right-0">
